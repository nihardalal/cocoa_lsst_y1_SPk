...
One model evaluation:
        ...
        $(cocoa)(.local) mpirun -n 1 --oversubscribe --mca btl tcp,self --bind-to core:overload-allowed --rank-by core --map-by numa:pe=${OMP_NUM_THREADS} cobaya-run ./projects/lsst_y1/EXAMPLE_EVALUATE1.yaml -f
