...
:two: **Step 2 of 6**: go to the `projects` folder and clone the Cosmolike LSST-Y1 project:
        ...
        $(cocoapy38) git clone --depth 1 https://github.com/CosmoLike/cocoa_lsst_y1.git lsst_y1 
...
:warning: **Warning** :warning: Cocoa developers should drop the shallow clone option `--depth 1`; they should also authenticate to GitHub via SSH keys:
        ...
        $(cocoapy38) git clone git@github.com:CosmoLike/cocoa_lsst_y1.git lsst_y1
...
:four: **Step 4 of 6**: compile the project
        ...
        $(cocoapy38)(.local) source ./projects/lsst_y1/scripts/compile_lsst_y1
...
One model evaluation:
        ...
        $(cocoapy38)(.local) mpirun -n 1 --oversubscribe --mca btl vader,tcp,self --bind-to core:overload-allowed --rank-by core --map-by numa:pe=${OMP_NUM_THREADS} cobaya-run ./projects/lsst_y1/EXAMPLE_EVALUATE1.yaml -f
