...
samples.saveAsText(chaindir + '/.VM_P19_TMP1')
# --------------------------------------------------------------------------------
...
samples.addDerived(100*p.omegab,name='ob100',label='{100 \\Omega_b}')
samples.addDerived(10*p.ns,name='ns10',label='{10 n_s}')
samples.saveAsText(chaindir + '/.VM_P19_TMP2')
# --------------------------------------------------------------------------------
...
param_3d = None
g.triangle_plot([chaindir + '/.VM_P19_TMP1',chaindir + '/.VM_P19_TMP2'],
parameter,
